...
export default function Footer({hideFooterPath}) {

 const pathname = usePathname();

 const shouldHideFooter = hideFooterPath.some(path => pathname.startsWith(path));
    ...
    <footer className=" bg-gray-900 ">
      <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
          <div className="mx-auto max-w-sm lg:max-w-none">
            ...
            <div className="mt-6 flex justify-center gap-4 lg:justify-start">
              <a
                className=" transition hover:text-gray-700/75 text-white hover:text-white/75"
                href="#"
                target="_blank"
                rel="noreferrer"
              >
        ...
        <div className="mt-16 border-t  pt-8 border-gray-800">
          <p className="text-center text-xs/relaxed text-gray-500 text-gray-400">
